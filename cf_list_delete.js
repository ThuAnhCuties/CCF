import { deleteZeroTrustListsOneByOne, getZeroTrustLists } from './lib/api.js';
...
try {
  ...
  console.error('Fatal error during list deletion:', error);
  try {
    await notifyWebhook(`CF List Delete script FAILED: ${error}`);
  } catch (webhookErr) {
