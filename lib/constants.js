...
// Allowlist mặc định (giữ nguyên từ repo gốc)
...
// Danh sách domain quan trọng luôn được thêm vào allowlist (dịch, mạng xã hội...)
// Bạn có thể thêm/xóa domain tại đây.
export const EXTRA_ALLOWLIST_DOMAINS = [
  "translate.googleapis.com",
  "translate.google.com",
  "translation.googleapis.com",
  "translate-pa.googleapis.com",
  // Thêm domain Facebook nếu cần:
  // "facebook.com",
  // "fbcdn.net",
  // "messenger.com",
];
